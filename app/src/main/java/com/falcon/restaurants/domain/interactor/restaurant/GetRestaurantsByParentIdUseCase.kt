...
class GetRestaurantsByParentIdUseCase @Inject constructor(
    private val restaurantRepository: RestaurantRepository
    ){

    fun execute(parent_id: String): Observable<List<Restaurant>> = restaurantRepository.getByParentId(parent_id)
